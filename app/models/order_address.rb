class OrderAddress
  ...
  attr_accessor :postcode, :prefecture_id, :municipalities, :address, :building_name, :phone_number, :item_id, :user_id, :price,
                :token, :item
  ...
  def save
    ...
    order = Order.create(user_id:, item_id:, price:, token:)
